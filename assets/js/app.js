...
/***/ "./resources/js/Composables/MobileMenu.js":
/*!************************************************!*\
  !*** ./resources/js/Composables/MobileMenu.js ***!
  \************************************************/
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  var mobileMenuElement = document.getElementById('mobile-navigation');
  mobileMenuElement.style.top = "".concat(headerElementHeight - 1, "px");
  ...
  var overlayElement = document.getElementById('mobile-overlay');
...
function addHeaderPadding() {
  ...
  if (headerElement) {
    document.body.style.paddingTop = headerElement ? "".concat(headerElement.offsetHeight, "px") : 0;
  }
}
...
window.toggleMobileMenu = __webpack_require__(/*! ./Composables/MobileMenu */ "./resources/js/Composables/MobileMenu.js");
